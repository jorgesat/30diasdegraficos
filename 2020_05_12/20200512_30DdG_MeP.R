...
MeP_gg <- ggplot(MeP_grafico, aes(x = reorder(Country.Region, value), y = value)) +
  coord_flip() +
  ...
  labs(title = "Porcentaje de mujeres en el parlamento nacional",
       subtitle = paste0("Al año 2019 en América del Sur"),
  ...
  geom_flag(y = -1, aes(country = tolower(iso2c)), size = 4)
